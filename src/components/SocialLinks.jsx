...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/muhammad-rakib-52b23a2a4/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@raakiib_",
    icon: Instagram,
    url: "https://www.instagram.com/raakiib_/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@rakibrockz",
    icon: Youtube,
    url: "https://www.youtube.com/@rakibrockz",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@RakibStackDev",
    icon: Github,
    url: "https://github.https://github.com/RakibStackDev/EkiZR",
    color: "#ffffff",
  ...
  },
  {
    ...
    <title>Tiktok</title>
    <g id="Icon/Social/tiktok-color" stroke="none" strokewidth="8" fill="none" fill-rule="evenodd">
